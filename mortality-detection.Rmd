...
```{r}
amwo_data <- getMovebankData(study = "American Woodcock Migration Ecology in Eastern North America", login = readRDS(here::here("movebank_credentials.rds")), removeDuplicatedTimestamps=TRUE, timestamp_end = "20230731000000000") %>% as.data.frame()
